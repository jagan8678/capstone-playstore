...
const AddApplication = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values, { setSubmitting, resetForm, setStatus }) => {
            ...
            axios.post('http://localhost:5001/api/applications/create', values, {
                headers: {
    ...
    return (
        <div style={backgroundImageStyle}>
            <div className="container mt-5">
                <h2 className="text-center mb-4">Add Application to Playstore</h2>
                <div className="card">
                    <div className="card-body">
                        <form onSubmit={formik.handleSubmit}>
                            ...
                            {formik.status === 'success' && <div className='text-success mt-3'>Application added successfully!</div>}
                            {formik.status === 'error' && <div className='text-danger mt-3'>Error adding application. Please try again.</div>}
                        </form>
                    </div>
                </div>
            </div>
